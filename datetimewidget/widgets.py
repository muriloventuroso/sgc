...
BOOTSTRAP_INPUT_TEMPLATE = {
    2: """
       <div id="box-%(id)s"  class="controls input-group date">
           %(rendered_widget)s
           %(clear_button)s
       ...
       """,
    3: """
       <div id="box-%(id)s" class="input-group date">
           %(rendered_widget)s
...
CLEAR_BTN_TEMPLATE = {2: """<span class="add-on"><i class="icon-remove"></i></span>""",
                      ...
                      4: """<span class="input-group-append"><span class="glyphicon glyphicon-remove"></span></span>"""}
